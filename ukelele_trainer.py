...
model = load_model('ukelele_learner_1.h5')
# chord_dict = {0: 'A', 1: 'Bm', 2: 'C', 3: 'Cadd9', 4: 'D', 5: 'F',6: 'G',7: 'G_C'}
chord_dict = {0: 'A', 1: 'Am', 2: 'C', 3: 'D', 4: 'Dm', 5: 'Em',6: 'F',7: 'G'}
...
def main():
    ...
    result = cv2.VideoWriter('ukelele_output_2.avi',cv2.VideoWriter_fourcc(*'MJPG'),30, size)
    while cap.isOpened():
